...
/// Sensor parameters
    ...
    "Temporisation",            "Time delay",               "Tempo di ritardo",         "Temporización",            "Zeitverzögerung",          // 2.4.0, modify Italian translation
    ...
    "Attenzione, questo parametro deve essere modificato utilizzando un luxmetro. Consultare la scheda tecnica. Volete continuare ?", \
    ...
    "Système de détection",     "Detection scheme",         "Schema di rilevazione",   "Sistema de detección",     "Detektionsschema",         // 2.4.0, modify Italian translation
    ...
    "Mode",                     "Mode",                     "Modalità",   "Modo",                     "Modus",                    // 2.4.0, modify Italian translation
    ...
    "minuterie",               "Timer switch",           "interruttore a tempo",             "Timer",              "temporizador",
    "double niveau",                         "Bilevel",                "doppio livello",                  "Doppelstufe",                  "doble nivel",
    ...
    "boucle fermée",            "close loop",               "Anello chiuso",               "bucle cerrado",               "geschloss. Regelkreis",
    ...
    "Groupe",                   "Group",                    "Gruppo",                  "Grupo",                    "Gruppe",
    ...
    "Détection",                "Detection",                "Rilevazione",              "Detección",                "Erkennung",                // 2.4.0, modify Italian translation
    "Mode passage",             "Walkthrough",              "Walkthrough",              "Modo paso",                "Rundgang",                 // 2.4.0, modify Italian translation
    "détection du soleil",      "sun detection",    "Rilevazione luce solare",    "detección de luz solar",            "Sonnenerkennung",
    ...
    "Europe",                   "Europe",                   "Europa",                   "Europe",                   "Europe",                   // 2.4.0
    ...
    "Apport de lumière actuel", "Current provision of light", "Contributo di luce",  "Brillo lámpara actual",    "Aktuelle Lichtbereitstellung",     // Too long
		"fuseau horaire",								"Time zones",									"Fuso orario",							"Huso horario",								"Zeitzone",

/// 2.2.0
    "Fonction room control",    "Functions room control",   "Room Controller",    "Funciones room control",   "Raumüberw.-funktionen",            // 2.4.0, modify Italian translation, nothing actually changed
    "Réinitialisation room",    "Reinitialize room",        "Reinizializza RC",       "Reinicializar room",       "Raumüberw. neu einstellen",        // 2.4.0, modify Italian translation
...
/// 2.2.0
    ...
    "Capacitif forcé",          "Forced capacitive",        "FORZATO CAPACITIVO",        "capacitivo forzado",        "kapazitiv zwangsgeschaltet",
    "Inductif forcé",           "Forced inductive",         "FORZATO INDUTTIVO",         "inductivo forzado",         "induktiv zwangsgeschaltet",
    "Capacitif auto",           "Auto capacitive",          "AUTO CAPACITIVO",          "capacitivo automático",          "kapazitiv Auto",
    "Inductif auto",            "Auto inductive",           "AUTO INDUTTIVO",           "inductivo automático",           "induktiv Auto",
...
/// Files
    ...
    "Désolé, ce n'est pas possible avec les détecteurs BUS.",       "Sorry, it's not possible with BUS sensors.",   "Spiacente, questo non è possibile con i sensori BUS.",       "Lo siento, esto no es posible con los detectores BUS.",        "Leider ist es nicht möglich mit BUS-Sensoren.",
...
/// 2.2.0
    ...
    "Attendez sous le capteur pendant l'envoi du fichier.",         "Wait under sensor during file sending.",       "Attendere sotto il sensore durante l'invio dei file.",       "Esperar delante del detector mientras que se envía el archivo.",       "Warten Sie unter Sensor während Dateiübertragung.",
...
/// Settings
    ...
    "Etes-vous sûr de vouloir passer à l'application Eclairage de Sécurité ?",  "Do you really want to switch to Emergency Lighting application?",  "Si vuole veramente passare all'applicazione Illuminazione d'emergenza?",  "¿Está seguro de que desea pasar a la aplicación Luminaria de emergencia?",  "Möchten Sie wirklich in die Sicherheitsleuchten-Anwendung wechseln?",
    ...
    "Recommencez…",        "Please restart...",        "Per favore, riavviare…",        "Reinicie…",        "Bitte wiederholen…",
#endif  // #ifndef NO_APPSWITCH

/// Test
    "Test fonctionnement",      "Walk test",                "Walk test",                "Test de funcionamiento",   "Gehtest",
    "Fin temporisation",        "End time delay",           "Fine tempo di ritardo",    "Fin temporización",        "Endzeitverzögerung",       // 2.4.0, modify Italian translation
...
/// Read parameters
    ...
    "Erreur lors de la lecture. Essayez à nouveau.",    "Error reading. Try again.",            "Errore di lettura. Riprovare",              "Error de lectura. Vuelva a intentarlo.",                       "Fehler beim Lesen. Erneut versuchen.",
    "Valeur de(s) paramètre(s) inconnue.",              "Unknown value for parameter(s).",      "Valore/i sconosciuto/i per il/i parametro/i",          "Valor de parámetro(s) desconocido",                              "Unbekannter Wert für den Parameter. ",
...
//2.4.1
	...
	"Identifiant d'appareil Zigbee",	"Device ID zigbee",	"Identificativo apparecchio Zigbee",	"Identificador del aparato Zigbee",	"Zigbee Gerätekennung",
	"Micrologiciel contrôleur",	"Controller firmware",		"Controller firmware",		"Controlador de micro programa informático",	"Regler-Firmware",
...
const unsigned char *strings_on_level_titile[] ={"Niveau d'allumage","ON level","livello di illuminazione","Leuchtstärke","nivel de iluminación"}; 
